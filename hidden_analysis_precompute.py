...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='generative/recorded_gen_samples')
...
def run():
    args = parse_args()
    num_episodes = 100#2000  # number of episodes to make plots for
    num_generated_samples = 100 # number of generated samples to use
